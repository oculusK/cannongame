...
public class Main {
    public static void main(String[] args) {
        ...
        while (world.getCount() < BALL_COUNT) {
            ...
            MovableBall ball = new MovableBall(new Point(x, y), radius, Color.RED);
        ...
        MovableBall ball5 = new MovableBall(new Point(50, 50), 25, Color.BLUE);
        ball5.setMotion(new Motion(15, 20));

        world.add(ball5);
        world.addEffect(new Motion(0, -1));
        world.addEffect(new Motion(3, 0));
